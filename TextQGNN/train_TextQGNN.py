...
parser.add_argument("--model", default="GatedQGNN", help="GatedQGNN, GatedGNN")
...
print("Training GatedQGNN")
model = GatedQGNN(feature_dim_size=feature_dim_size,
                hidden_size=args.hidden_size,
                num_steps=args.num_GNN_layers,
