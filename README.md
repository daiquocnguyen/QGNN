...
- Scipy		1.3
- Tensorflow 	1.14 or
- Pytorch 	1.5.0	and Cython	0.29.13. You should change to the `log_uniform` directory to perform `make` to build `SampledSoftmax`, and then add the `log_uniform` directory to your PYTHONPATH.
...
- See [Graph-Transformer](https://github.com/daiquocnguyen/Graph-Transformer) for more details about the unsupervised learning.
